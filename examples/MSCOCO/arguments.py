...
class IndexArguments:
    ...
    emb_size: int = field(default=512, metadata={"help": "The dimension of embedding"})
    save_path: str = field(default='./data/MSCOCO/embedding/parameters', metadata={"help": "Path of all parameters of save index"})
...
@dataclass
class DataArguments:
    data_dir: str = field(default='./data/MSCOCO/embedding', metadata={"help": "The path to all data"})
