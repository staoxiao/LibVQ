...
class DataArguments:
    ...
    doc_embeddings_file: str = field(default=None, metadata={"help": "The path to embeddings, and the embeddings should be saved as .npy or .memmap"})
    query_embeddings_file: str = field(default=None, metadata={"help": "The path to embeddings, and the embeddings should be saved as .npy or .memmap"})
