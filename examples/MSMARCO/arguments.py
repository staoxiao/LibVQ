...
class IndexArguments:
    ...
    save_path: str = field(default='./data/MSMARCO/parameters', metadata={"help": "Path of all parameters of save index"})
...
@dataclass
class DataArguments:
    data_dir: str = field(default='./data/MSMARCO', metadata={"help": "The path to all data"})
